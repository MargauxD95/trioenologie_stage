...
class MainController extends AbstractController
{
    ...
    // public function carousel(CarouselRepository $carouselRepository): Response
    // {
    //     $carousels = $carouselRepository->findAll();
    //     dump($carousels);
    //     die;
    ...
    // Route pour afficher la page asso (navbar)
    ...
    // Route pour afficher les galeries photo
    #[Route('/galeries', name:'galeries')]
    public function galeries(GalleryRepository $galleryRepository)
    {
        $galleries = $galleryRepository->findAll();
        return $this->render('main/pages/gallery/galerie.html.twig', [
            "galleries" => $galleries
        ]);
    }

    // Route pour afficher une galerie particulière
    #[Route('/galerie/{id}', name:'show_gallery', methods: ['GET'])]
    public function showGalerie(Gallery $gallery)
    {
        return $this->render('main/pages/gallery/showGallery.html.twig', [
            'gallery' => $gallery,
        ]);
    }
