...
class __TwigTemplate_4ba1f307c5f909ffec534a861a03d73a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 26
        echo "    ";
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 26), "attributes", [], "any", false, false, false, 26), "get", [0 => "_route"], "method", false, false, false, 26) == "editor_article_edit")) {
            echo "              
    <div class=\"container\" id=\"illustrations\">
        ...
        <section class=\"row \">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["picture"]) {
                ...
                // line 34
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("editor_article_unlinkPicture", ["article_id" => twig_get_attribute($this->env, $this->source, ($context["article"] ?? null), "id", [], "any", false, false, false, 34), "id" => twig_get_attribute($this->env, $this->source, $context["picture"], "id", [], "any", false, false, false, 34)]), "html", null, true);
                echo "\" >Détacher</a>
                </div>
            </div>        
            ";
...
";
    ...
    {
        return new Source("", "editor/article/formArticle.html.twig", "/home/u390036024/domains/trioenologie.fr/public_html/templates/editor/article/formArticle.html.twig");
    }
}
