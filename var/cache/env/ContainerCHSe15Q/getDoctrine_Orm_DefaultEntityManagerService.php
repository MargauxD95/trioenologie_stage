...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelEnvDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/vendor/tattali/calendar-bundle/src/Entity')]), 'CalendarBundle\\Entity');
