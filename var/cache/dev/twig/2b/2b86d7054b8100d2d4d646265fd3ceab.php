...
class __TwigTemplate_30079bc56eddc1e377f070b5837121ca extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  124 => 23,  118 => 22,  115 => 21,  101 => 20,  95 => 17,  91 => 15,  85 => 13,  82 => 12,  78 => 11,  60 => 10,  56 => 9,  52 => 8,  43 => 1,);
    }
                    ...
                    {% for picture in carousel.CarouselPictures %}
                        {% if loop.index0 == 0 %} {# si c'est la première image de la boucle ajoute active dans class  #}
                          <div class=\"carousel-item active\">
                            <img src=\"{{ asset('/uploads/pictures/'~ picture.picture.pictureFile) }}\" class=\"d-block w-100\" alt=\"...\" >
                          </div>
                          {% else %}                    
                          <div class=\"carousel-item\">
                            <img src=\"{{ asset('/uploads/pictures/'~ picture.picture.pictureFile) }}\" class=\"d-block w-100\" alt=\"...\" >
...
", "main/partials/carousels/carouselHome.html.twig", "C:\\Users\\magau\\OneDrive\\Documents\\GitHub\\trioenologie\\templates\\main\\partials\\carousels\\carouselHome.html.twig");
    }
}
