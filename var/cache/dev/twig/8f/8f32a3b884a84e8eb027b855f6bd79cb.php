...
class __TwigTemplate_22edbfafc12a7568b14892dd8e5ab19b extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <div class=\"row mt-3\">
        ...
        <div class=\"col-12\">
            <h1><span class=\"error\">403</span> - Accès refusé</h1>
            <h2></h2>
            <p class=\"text-center\">Désolé, l'accès à cette page est interdit.</p>
        </div>
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "C:\\Users\\magau\\OneDrive\\Documents\\GitHub\\trioenologie_stage\\templates\\bundles\\TwigBundle\\Exception\\error403.html.twig");
    }
}
