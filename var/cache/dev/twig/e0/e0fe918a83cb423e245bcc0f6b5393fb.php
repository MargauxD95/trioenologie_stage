...
class __TwigTemplate_3aa173579010949f83474328bffeb2c2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/user/showUser.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/user/showUser.html.twig"));
    ...
    <div class=\"row justify-content-center\">
        ...
        echo "\" class=\"btn btn-return\">
            ...
            <a href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 32, $this->source); })()), "id", [], "any", false, false, false, 32)]), "html", null, true);
...
";
    ...
    {
        return array (  131 => 32,  125 => 29,  115 => 22,  108 => 18,  101 => 14,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container col-lg-12 col-md-10 col-sm-8 mt-5\">
    ...
    <h1 class=\"text-center rF mt-3 mb-3\">Utilisateur : {{user.email}}</h1>

    <table class=\"table text-center table-borderless table-striped\">
        <tbody class=\"tab\">
            <tr>
                <th class=\"col-2 rFi\">ID</th>
                <td class=\"rF\">{{ user.id }}</td>
            </tr>
            <tr>
                <th class=\"col-2 rFi\">E-mail</th>
                <td class=\"rF\">{{ user.email }}</td>
            </tr>
            <tr>
                <th class=\"col-2 rFi\">Rôle</th>
                <td class=\"rF\">{{ user.roles ? user.roles|json_encode : '' }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <div class=\"row justify-content-center\">
        <div class=\"col-3 ms-5\">
            ...
            <a href=\"{{ path('admin_user_edit', {'id':user.id}) }}\" class=\"btn btn-update\">
                <i class=\"bi bi-pencil\"></i>
            </a>
        </div>
    </div>
