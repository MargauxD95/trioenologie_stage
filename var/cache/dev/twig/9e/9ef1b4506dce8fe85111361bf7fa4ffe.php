...
class __TwigTemplate_84ec4adb44aaa8be7e6363a374fcc0cc extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container mt-4\">
    ...
    <a href=\"{{ path('admin_category_new') }}\" class=\"btn btn-submitForm col-sm-2 mt-3\">Nouvelle catégorie</a>
    ...
    <table class=\"table tab\">
        ...
        {% for category in categories %}
            <tr class=\"tab\">
                <td class=\"rFb\">{{ category.id }}</td>
                <td>{{ category.name }}</td>
                <td>
                    <a href=\"{{ path('admin_category_show', {'id': category.id}) }}\"><i class=\"bi bi-eye-fill\"></i></a>
                </td>
                <td>
                    <a href=\"{{ path('admin_category_edit', {'id': category.id}) }}\"><i class=\"bi bi-pencil-square\"></i></a>                
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "admin/category/categories.html.twig", "C:\\Users\\magau\\OneDrive\\Documents\\GitHub\\trioenologie_stage\\templates\\admin\\category\\categories.html.twig");
    }
}
