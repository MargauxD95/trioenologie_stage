...
$('#picture_pictureFile').change(function(){
            
    var files = $("#picture_pictureFile")[0].files; // on crée un array "files" qui récupère les fichiers uploadés dans le champ #gallery_pictures
