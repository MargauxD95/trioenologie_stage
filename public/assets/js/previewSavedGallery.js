...
$('#gallery_savedPictures').change(function(){
    preview = $('#previewSaved'); // le container div#previewSaved
    preview.empty(); // vide le container
    count = $("#gallery_savedPictures option:selected").length; // ccompte le nbre d'éléments sélectionnés
    ...
    $("#gallery_savedPictures option:selected").each(function(i){
