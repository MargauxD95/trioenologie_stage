...
$('#carousel_pictures').change(function(){
            
    var files = $("#carousel_pictures")[0].files; // on crée un array "files" qui récupère les fichiers uploadés dans le champ #gallery_pictures
